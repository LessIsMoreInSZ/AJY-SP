    ...
    public partial class WBenzuControl : UserControl
    {
        ...
        private void SetAllData()
        {
            try
            {
                ...
                CommonAdsUi.SetBtnColorGrayAndGreen(btntankv1, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[0]);
                CommonAdsUi.SetBtnColorGrayAndGreen(btntankv2, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[1]);
                CommonAdsUi.SetBtnColorGrayAndGreen(btntankv3, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[2]);
                CommonAdsUi.SetBtnColorGrayAndGreen(btntankv4, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[3]);
                CommonAdsUi.SetBtnColorGrayAndGreen(btntankv5, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[4]);
            }
            catch (Exception ex)
            {
