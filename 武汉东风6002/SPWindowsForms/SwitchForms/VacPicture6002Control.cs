    ...
    public partial class VacPicture6002Control : UserControl
    {
        ...
        private void SetAllData()
        {
            try
            {
                ...
                CommonAdsUi.SetIconBackOnOff(pump1, GlobalVar.plcData.hmi_Vacsource.status_pump[0]);
                CommonAdsUi.SetIconBackOnOff(pump2, GlobalVar.plcData.hmi_Vacsource.status_pump[1]); 
                CommonAdsUi.SetIconBackOnOff(pump3, GlobalVar.plcData.hmi_Vacsource.status_pump[2]);
                ...
                CommonAdsUi.SetIconBackOnOff(pumpV1, GlobalVar.plcData.hmi_Vacsource.led_pumps_v[0]);
                CommonAdsUi.SetIconBackOnOff(pumpV2, GlobalVar.plcData.hmi_Vacsource.led_pumps_v[1]);
                CommonAdsUi.SetIconBackOnOff(pumpV3, GlobalVar.plcData.hmi_Vacsource.led_pumps_v[2]);
                CommonAdsUi.SetIconBackOnOff(pumpV4, GlobalVar.plcData.hmi_Vacsource.led_pumps_v[3]);
                CommonAdsUi.SetIconBackOnOff(pumpV5, GlobalVar.plcData.hmi_Vacsource.led_pumps_v[4]);
                CommonAdsUi.SetIconBackOnOff(pumpV6, GlobalVar.plcData.hmi_Vacsource.led_pumps_v[5]);

                CommonAdsUi.SetIconBackOnOff(tank1V1, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[0]);
                CommonAdsUi.SetIconBackOnOff(tank1V2, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[1]);
                CommonAdsUi.SetIconBackOnOff(tank1V3, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[2]);
                CommonAdsUi.SetIconBackOnOff(tank1V4, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[3]);
                CommonAdsUi.SetIconBackOnOff(tank1V5, GlobalVar.plcData.hmi_Vacsource.led_ExTank_v[4]);

                CommonAdsUi.SetBtnColorGrayAndGreen(btnESource, GlobalVar.plcData.UPS.E_setsource);
                CommonAdsUi.SetBtnColorGrayAndGreen(btnCSource, GlobalVar.plcData.UPS.C_setsource);
                if (GlobalVar.plcData.UPS.E_setsource)
                    btnESource.Text = "E_Pump";
                else
                    btnESource.Text = "E_Tank";

                if (GlobalVar.plcData.UPS.C_setsource)
                    btnCSource.Text = "C_Pump";
                else
                    btnCSource.Text = "C_Tank";
        ...
        private void btnESource_Click(object sender, EventArgs e)
        {
            if (!CommonFunction.CheckAccessGongyi())
            {
                Work.ShowErrorMessage(LanguageSet.SetL("Others", "NotAccsess"));
            ...
            bool eCurrentValue = GlobalVar.plcData.UPS.E_setsource;
            int beforeLength = 348;
            string varName = GlobalVar.commonAdsControl.st_ups_name;// st_ups
            GlobalVar.commonAdsControl.WriteCommonBoolByBefore(varName, beforeLength, !eCurrentValue);
        }

        private void btnCSource_Click(object sender, EventArgs e)
        {
            if (!CommonFunction.CheckAccessGongyi())
            {
                Work.ShowErrorMessage(LanguageSet.SetL("Others", "NotAccsess"));
            ...
            bool cCurrentValue = GlobalVar.plcData.UPS.C_setsource;
            int beforeLength = 349;
            string varName = GlobalVar.commonAdsControl.st_ups_name;// st_ups
            GlobalVar.commonAdsControl.WriteCommonBoolByBefore(varName, beforeLength, !cCurrentValue);
        }
    }
