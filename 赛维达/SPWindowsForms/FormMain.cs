...
namespace SPWindowsForms
{
    public partial class FormMain : Form
    {
        ...
        public WAlarmTableControl wAlarmTableControl;//报警管理
        public WTongdaoControl wTongdaoControl;
        public WManualControl wManualControl;// 手动测试
        public WAutoControl wAutoControl;// 自动操作
        ...
        public FormMain()
        {
            ...
            button_menu2.EnabledChanged += Control_EnabledChanged;
        }

        private void Control_EnabledChanged(object sender, EventArgs e)
        {
            Control control = sender as Control;
            control.BackColor = Color.FromArgb(64, 64, 64); // 设置按钮背景色
        }
        ...
        private void IniTopPanel()
        {
            ...
            uILedChnBulbDs.Add(led_ch11);
            uILedChnBulbDs.Add(led_ch12);
            ...
            uILedChnBulbDs_label.Add(label_D9);
            uILedChnBulbDs_label.Add(label_D10);
